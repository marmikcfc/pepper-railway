...
export type EventData =
  ...
  | { type: 'response'; text: string; is_error: boolean; model_id?: string; input_tokens?: number; output_tokens?: number; cache_creation_input_tokens?: number; cache_read_input_tokens?: number }
